...
Cyp2C9_Frequencies<- read_excel("Cyp2C9_Frequencies_2025.xlsx")
...
Cyp2C9_Phenotypes<- read_excel("Cyp2C9_Diplotypes_2025.xlsx")
...
Cyp2C9_Phenotypes[Cyp2C9_Phenotypes== "Normal/Routine/Low Risk"]<- "Normal/Routine/Low Risk"
...
Cyp2C9_Phenotypes_Test[Cyp2C9_Phenotypes_Test== "*62"]<- Cyp2C9_Tests["*62","Tier Two"]
Cyp2C9_Phenotypes_Test[Cyp2C9_Phenotypes_Test== "*63"]<- Cyp2C9_Tests["*63","Tier Two"]
Cyp2C9_Phenotypes_Test[Cyp2C9_Phenotypes_Test== "*66"]<- Cyp2C9_Tests["*66","Tier Two"]
Cyp2C9_Phenotypes_Test[Cyp2C9_Phenotypes_Test== "*67"]<- Cyp2C9_Tests["*67","Tier Two"]
Cyp2C9_Phenotypes_Test[Cyp2C9_Phenotypes_Test== "*72"]<- Cyp2C9_Tests["*72","Tier Two"]
Cyp2C9_Phenotypes_Test[Cyp2C9_Phenotypes_Test== "*73"]<- Cyp2C9_Tests["*73","Tier Two"]
Cyp2C9_Phenotypes_Test[Cyp2C9_Phenotypes_Test== "*75"]<- Cyp2C9_Tests["*75","Tier Two"]
...
AfricanPhenotypes[AfricanPhenotypes== "*62"]<- Cyp2C9_Frequencies["*62","African American/Afro-Caribbean"]
AfricanPhenotypes[AfricanPhenotypes== "*63"]<- Cyp2C9_Frequencies["*63","African American/Afro-Caribbean"]
AfricanPhenotypes[AfricanPhenotypes== "*66"]<- Cyp2C9_Frequencies["*66","African American/Afro-Caribbean"]
AfricanPhenotypes[AfricanPhenotypes== "*67"]<- Cyp2C9_Frequencies["*67","African American/Afro-Caribbean"]
AfricanPhenotypes[AfricanPhenotypes== "*72"]<- Cyp2C9_Frequencies["*72","African American/Afro-Caribbean"]
AfricanPhenotypes[AfricanPhenotypes== "*73"]<- Cyp2C9_Frequencies["*73","African American/Afro-Caribbean"]
AfricanPhenotypes[AfricanPhenotypes== "*75"]<- Cyp2C9_Frequencies["*75","African American/Afro-Caribbean"]
...
SumAfricanAbnormal<- sum(AfricanAbnormal$Probability, na.rm = TRUE)
...
SumAfricanAbnormalCorrect<- sum(AfricanAbnormal$Probability, na.rm = TRUE)
...
AmericanPhenotypes[AmericanPhenotypes== "*62"]<- Cyp2C9_Frequencies["*62","American"]
AmericanPhenotypes[AmericanPhenotypes== "*63"]<- Cyp2C9_Frequencies["*63","American"]
AmericanPhenotypes[AmericanPhenotypes== "*66"]<- Cyp2C9_Frequencies["*66","American"]
AmericanPhenotypes[AmericanPhenotypes== "*67"]<- Cyp2C9_Frequencies["*67","American"]
AmericanPhenotypes[AmericanPhenotypes== "*72"]<- Cyp2C9_Frequencies["*72","American"]
AmericanPhenotypes[AmericanPhenotypes== "*73"]<- Cyp2C9_Frequencies["*73","American"]
AmericanPhenotypes[AmericanPhenotypes== "*75"]<- Cyp2C9_Frequencies["*75","American"]
...
SumAmericanAbnormal<- sum(AmericanAbnormal$Probability, na.rm = TRUE)

###Population Frequency of Abnormal Phenotypes Correctly Detected 
AmericanAbnormalCorrect<- subset(AmericanAbnormal, Test== "Observable")
SumAmericanAbnormalCorrect<- sum(AmericanAbnormalCorrect$Probability, na.rm = TRUE)
...
CentralPhenotypes[CentralPhenotypes== "*62"]<- Cyp2C9_Frequencies["*62","Central/South Asian"]
CentralPhenotypes[CentralPhenotypes== "*63"]<- Cyp2C9_Frequencies["*63","Central/South Asian"]
CentralPhenotypes[CentralPhenotypes== "*66"]<- Cyp2C9_Frequencies["*66","Central/South Asian"]
CentralPhenotypes[CentralPhenotypes== "*67"]<- Cyp2C9_Frequencies["*67","Central/South Asian"]
CentralPhenotypes[CentralPhenotypes== "*72"]<- Cyp2C9_Frequencies["*72","Central/South Asian"]
CentralPhenotypes[CentralPhenotypes== "*73"]<- Cyp2C9_Frequencies["*73","Central/South Asian"]
CentralPhenotypes[CentralPhenotypes== "*75"]<- Cyp2C9_Frequencies["*75","Central/South Asian"]
...
SumCentralAbnormal<- sum(CentralAbnormal$Probability, na.rm = TRUE)

###Population Frequency of Abnormal Phenotypes Correctly Detected 
CentralAbnormalCorrect<- subset(CentralAbnormal, Test== "Observable")
SumCentralAbnormalCorrect<- sum(CentralAbnormalCorrect$Probability, na.rm = TRUE)
...
EastPhenotypes[EastPhenotypes== "*62"]<- Cyp2C9_Frequencies["*62","East Asian"]
EastPhenotypes[EastPhenotypes== "*63"]<- Cyp2C9_Frequencies["*63","East Asian"]
EastPhenotypes[EastPhenotypes== "*66"]<- Cyp2C9_Frequencies["*66","East Asian"]
EastPhenotypes[EastPhenotypes== "*67"]<- Cyp2C9_Frequencies["*67","East Asian"]
EastPhenotypes[EastPhenotypes== "*72"]<- Cyp2C9_Frequencies["*72","East Asian"]
EastPhenotypes[EastPhenotypes== "*73"]<- Cyp2C9_Frequencies["*73","East Asian"]
EastPhenotypes[EastPhenotypes== "*75"]<- Cyp2C9_Frequencies["*75","East Asian"]
...
SumEastAbnormal<- sum(EastAbnormal$Probability, na.rm = TRUE)

###Population Frequency of Abnormal Phenotypes Correctly Detected
EastAbnormalCorrect<- subset(EastAbnormal, Test== "Observable")
SumEastAbnormalCorrect<- sum(EastAbnormalCorrect$Probability, na.rm = TRUE)
...
EuropeanPhenotypes[EuropeanPhenotypes== "*62"]<- Cyp2C9_Frequencies["*62","European"]
EuropeanPhenotypes[EuropeanPhenotypes== "*63"]<- Cyp2C9_Frequencies["*63","European"]
EuropeanPhenotypes[EuropeanPhenotypes== "*66"]<- Cyp2C9_Frequencies["*66","European"]
EuropeanPhenotypes[EuropeanPhenotypes== "*67"]<- Cyp2C9_Frequencies["*67","European"]
EuropeanPhenotypes[EuropeanPhenotypes== "*72"]<- Cyp2C9_Frequencies["*72","European"]
EuropeanPhenotypes[EuropeanPhenotypes== "*73"]<- Cyp2C9_Frequencies["*73","European"]
EuropeanPhenotypes[EuropeanPhenotypes== "*75"]<- Cyp2C9_Frequencies["*75","European"]
...
SumEuropeanAbnormal<- sum(EuropeanAbnormal$Probability, na.rm = TRUE)

###Population Frequency of Abnormal Phenotypes Correctly Detected
EuropeanAbnormalCorrect<- subset(EuropeanAbnormal, Test== "Observable")
SumEuropeanAbnormalCorrect<- sum(EuropeanAbnormalCorrect$Probability, na.rm = TRUE)
...
LatinoPhenotypes[LatinoPhenotypes== "*62"]<- Cyp2C9_Frequencies["*62","Latino"]
LatinoPhenotypes[LatinoPhenotypes== "*63"]<- Cyp2C9_Frequencies["*63","Latino"]
LatinoPhenotypes[LatinoPhenotypes== "*66"]<- Cyp2C9_Frequencies["*66","Latino"]
LatinoPhenotypes[LatinoPhenotypes== "*67"]<- Cyp2C9_Frequencies["*67","Latino"]
LatinoPhenotypes[LatinoPhenotypes== "*72"]<- Cyp2C9_Frequencies["*72","Latino"]
LatinoPhenotypes[LatinoPhenotypes== "*73"]<- Cyp2C9_Frequencies["*73","Latino"]
LatinoPhenotypes[LatinoPhenotypes== "*75"]<- Cyp2C9_Frequencies["*75","Latino"]
...
SumLatinoAbnormal<- sum(LatinoAbnormal$Probability, na.rm = TRUE)

###Population Frequency of Abnormal Phenotypes Correctly Detected
LatinoAbnormalCorrect<- subset(LatinoAbnormal, Test== "Observable")
SumLatinoAbnormalCorrect<- sum(LatinoAbnormalCorrect$Probability, na.rm = TRUE)
...
NearPhenotypes[NearPhenotypes== "*62"]<- Cyp2C9_Frequencies["*62","Near Eastern"]
NearPhenotypes[NearPhenotypes== "*63"]<- Cyp2C9_Frequencies["*63","Near Eastern"]
NearPhenotypes[NearPhenotypes== "*66"]<- Cyp2C9_Frequencies["*66","Near Eastern"]
NearPhenotypes[NearPhenotypes== "*67"]<- Cyp2C9_Frequencies["*67","Near Eastern"]
NearPhenotypes[NearPhenotypes== "*72"]<- Cyp2C9_Frequencies["*72","Near Eastern"]
NearPhenotypes[NearPhenotypes== "*73"]<- Cyp2C9_Frequencies["*73","Near Eastern"]
NearPhenotypes[NearPhenotypes== "*75"]<- Cyp2C9_Frequencies["*75","Near Eastern"]
...
SumNearAbnormal<- sum(NearAbnormal$Probability, na.rm = TRUE)

###Population Frequency of Abnormal Phenotypes Correctly Detected
NearAbnormalCorrect<- subset(NearAbnormal, Test== "Observable")
SumNearAbnormalCorrect<- sum(NearAbnormalCorrect$Probability, na.rm = TRUE)
...
OceanianPhenotypes[OceanianPhenotypes== "*62"]<- Cyp2C9_Frequencies["*62","Oceanian"]
OceanianPhenotypes[OceanianPhenotypes== "*63"]<- Cyp2C9_Frequencies["*63","Oceanian"]
OceanianPhenotypes[OceanianPhenotypes== "*66"]<- Cyp2C9_Frequencies["*66","Oceanian"]
OceanianPhenotypes[OceanianPhenotypes== "*67"]<- Cyp2C9_Frequencies["*67","Oceanian"]
OceanianPhenotypes[OceanianPhenotypes== "*72"]<- Cyp2C9_Frequencies["*72","Oceanian"]
OceanianPhenotypes[OceanianPhenotypes== "*73"]<- Cyp2C9_Frequencies["*73","Oceanian"]
OceanianPhenotypes[OceanianPhenotypes== "*75"]<- Cyp2C9_Frequencies["*75","Oceanian"]
...
SumOceanianAbnormal<- sum(OceanianAbnormal$Probability, na.rm = TRUE)

###Population Frequency of Abnormal Phenotypes Correctly Detected 
OceanianAbnormalCorrect<- subset(OceanianAbnormal, Test== "Observable")
SumOceanianAbnormalCorrect<- sum(OceanianAbnormalCorrect$Probability, na.rm = TRUE)
...
SubPhenotypes[SubPhenotypes== "*62"]<- Cyp2C9_Frequencies["*62","Sub-Saharan African"]
SubPhenotypes[SubPhenotypes== "*63"]<- Cyp2C9_Frequencies["*63","Sub-Saharan African"]
SubPhenotypes[SubPhenotypes== "*66"]<- Cyp2C9_Frequencies["*66","Sub-Saharan African"]
SubPhenotypes[SubPhenotypes== "*67"]<- Cyp2C9_Frequencies["*67","Sub-Saharan African"]
SubPhenotypes[SubPhenotypes== "*72"]<- Cyp2C9_Frequencies["*72","Sub-Saharan African"]
SubPhenotypes[SubPhenotypes== "*73"]<- Cyp2C9_Frequencies["*73","Sub-Saharan African"]
SubPhenotypes[SubPhenotypes== "*75"]<- Cyp2C9_Frequencies["*75","Sub-Saharan African"]
...
SumSubAbnormal<- sum(SubAbnormal$Probability, na.rm = TRUE)

###Population Frequency of Abnormal Phenotypes Correctly Detected 
SubAbnormalCorrect<- subset(SubAbnormal, Test== "Observable")
SumSubAbnormalCorrect<- sum(SubAbnormalCorrect$Probability, na.rm = TRUE)

#Sensitivity
SubSensitivity<- SumSubAbnormalCorrect/SumSubAbnormal*100

SumSubAbnormalCorrect
SumSubAbnormal
SubAbnormal
SubAbnormal$Probability
sum(SubAbnormal$Probability)
